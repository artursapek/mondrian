...
class Event {
  static initClass() {
    ...
    this.prototype.current = false;
  
    // The index this event is at in archive.events
    this.prototype.position = undefined;
  }
  constructor() {}
  ...
  fromJSON(json) {
    ...
    switch (json.t[0]) {
      ...
      case "e":
        // ExistenceEvent
        let ee = new ExistenceEvent(json.a);
      ...
      case "p":
        ...
        let point = json.p;
        let at = json.i;
        let elem = parseInt(json.e, 10);
        let mode = { d: "delete", c: "create" }[json.t[2]];
        let pe = new PointExistenceEvent(elem, point, at);
        pe.mode = mode;
        return pe;
