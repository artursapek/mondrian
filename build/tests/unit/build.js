...
(function() {
  var Test, blob1, blob2, bz, bz1, bz10, bz2, bz3, bz4, bz5, bz6, bz7, bz8, bz9, ell1, hugepoly, ln1, ln110, ln2, ln3, ln4, ln5, ln6, ln7, ln8, p1, p2, p3, p4, poly1, poly2, poly3, pth1;

  Test = (function() {

    function Test(name, val, equalTo) {
      ...
      if (result.toString() === this.equalTo.toString()) {
        this.printSuccess(end.valueOf() - begin.valueOf());
      } else {
        this.printFailure(this.equalTo, result);
      }
    }

    Test.prototype.print = function(result) {
      return q('body').innerHTML += "<div class=\"test\">" + this.name + " " + result + "</div>";
    };

    Test.prototype.printSuccess = function(time) {
      return this.print("<span class=\"passed\">passed</span> in " + time + "ms");
    };

    Test.prototype.printFailure = function(expected, result) {
      return this.print("<br><span class=\"failed\">FAILED</span><br><u>Expected</u>: " + expected + " <br><u>Got</u>:      " + result + "<br>");
    };
  ...
  */
  ...
  blob1 = new Path({
    d: "M207.337,68.753c-39.326,19.102-65.168,95.506-47.191,106.742\ns78.652,53.933,104.495,28.09s47.191-133.708,30.337-134.832S207.337,68.753,207.337,68.753z"
  });
  ...
  new Test('Posn reflection [1]', (function() {
    return p1.reflect(p2);
  }), new Posn(90, 80));

  new Test('Posn reflection [2]', (function() {
    return p2.reflect(p1);
  }), new Posn(-30, -10));

  new Test('Posn reflection [3]', (function() {
    return p1.reflect(p1);
  }), p1);

  new Test('Posn linear interpolation (lerp) [1]', (function() {
    return p2.lerp(p3, 0.5);
  }), new Posn(53.1875, 485.2525));

  new Test('Posn linear interpolation (lerp) [2]', (function() {
    return p1.lerp(p2, 0.8);
  }), new Posn(42, 44));

  new Test('Posn add to Posn [1]', (function() {
    return p1.add(p2);
  }), new Posn(60, 70));

  new Test('Posn add to Posn [2]', (function() {
    return p2.add(p1);
  }), new Posn(60, 70));

  new Test('Posn add to Posn [3]', (function() {
    return p2.add(p3);
  ...
  new Test('Cubic polynomial roots [1]', (function() {
    return poly1.roots();
  ...
  new Test('Cubic Bezier intersection with Cubic Bezier [3]', (function() {
    return bz4.intersection(bz6);
  }), [new Posn(76.26664017448732, 27.28211939958595), new Posn(83.63548811847966, 26.07062056075148)]);

  new Test('Cubic Bezier intersection with Cubic Bezier [4]', (function() {
  ...
  new Test('Cubic Bezier intersection with Cubic Bezier [5]', (function() {
